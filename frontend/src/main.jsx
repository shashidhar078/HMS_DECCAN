...
import LabTechnicianLogin from './pages/auth/LabTechnicianLogin';
import LabTechnicianRegister from './pages/auth/LabTechnicianRegister';
import LabTechnicianDashboard from './pages/auth/LabTechnicianDashboard';
    ...
    <AuthProvider>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/auth/lab-technician-login" element={<LabTechnicianLogin />} />
          <Route path="/auth/lab-technician-register" element={<LabTechnicianRegister />} />
          <Route path="/auth/lab-technician-dashboard" element={<LabTechnicianDashboard />} />
        </Routes>
      </BrowserRouter>
    </AuthProvider>
  </React.StrictMode>
